    ...
    <main className="min-h-screen bg-gradient-to-b from-indigo-50 via-white to-white px-4 py-12 text-gray-900 sm:px-6">
      <div className="mx-auto flex max-w-4xl flex-col gap-8">
        ...
        <section className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">🔭 About Kottamia Observatory</h2>
        ...
        <section className="rounded-2xl border border-amber-100 bg-amber-50 p-6 shadow-sm sm:p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">🌕 Historical Achievements</h2>
        ...
        <section className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-indigo-200 bg-indigo-50 p-4">
              <h3 className="font-semibold text-gray-900 mb-2">📍 Observatory Location</h3>
              <p className="text-sm text-gray-700 font-mono">WRMH+J3P، طريق المرصد الفلكي, Cairo Governorate Desert, Cairo Governorate 4830301</p>
        ...
        <section className="rounded-2xl border border-blue-100 bg-blue-50 p-6 shadow-sm sm:p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">📝 Registration Period</h2>
          <div className="space-y-2">
            <p className="text-gray-700">
        ...
        <section className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
          <h3 className="text-xl font-bold text-gray-900 mb-3">📸 Event Photography</h3>
          <p className="text-gray-700">
