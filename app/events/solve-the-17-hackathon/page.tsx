    ...
    <div className="min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-50">
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <div className="mb-8 overflow-hidden rounded-2xl shadow-lg border border-emerald-100">
          <div
            className="relative aspect-16/7 bg-gray-200"
        ...
        <header className="mb-12">
          <h1 className="text-5xl font-bold mb-6 bg-linear-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
          ...
          <div className="flex flex-wrap gap-6 text-gray-700 mb-6">
            ...
            <div className="flex items-center gap-2">
              <span>📍</span>
              <span>
                Egypt University of Informatics, New Administrative Capital
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span>🏆</span>
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            A dynamic hackathon in collaboration with the Ministry of Youth &
            Sports, bringing together coders, innovators, and problem-solvers to
            turn ideas into real-world solutions tackling pressing global
            issues.
          </p>
        </header>
        ...
        <section className="mb-12 bg-white rounded-xl shadow-lg p-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            combining their technical skills with creative problem-solving to
            address real-world challenges. The event featured expert workshops,
            keynote speakers, and a competitive hackathon environment where
            participants competed for substantial prizes while making meaningful
            impact.
          </p>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 border-2 border-emerald-100 rounded-lg">
              <h3 className="font-bold text-lg text-gray-900 mb-2">
                💰 Free DataCamp Subscription
              </h3>
              <p className="text-gray-700">
                All participants received complimentary access to premium
                learning resources.
              </p>
            </div>
            <div className="p-6 border-2 border-teal-100 rounded-lg">
              ...
              <p className="text-gray-700">
                Total prize pool of 20,000 EGP awarded to winning teams.
              </p>
            </div>
            <div className="p-6 border-2 border-emerald-100 rounded-lg">
              <h3 className="font-bold text-lg text-gray-900 mb-2">
              ...
              <p className="text-gray-700">
                Tackle pressing issues with innovative tech solutions aligned
                with SDG goals.
              </p>
            </div>
            <div className="p-6 border-2 border-teal-100 rounded-lg">
              ...
              <p className="text-gray-700">
                Connect with like-minded innovators, mentors, and industry
                professionals.
              </p>
            </div>
          </div>
        ...
        <section className="mb-12 bg-linear-to-r from-emerald-50 to-teal-50 rounded-xl shadow-lg p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">
            Event Timeline
          </h2>
          <div className="space-y-4">
            <div className="p-4 bg-white border-l-4 border-emerald-500 rounded">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Keynote speakers and workshops from MathWorks and Orange Digital
                Center
              </p>
            </div>
            <div className="p-4 bg-white border-l-4 border-teal-500 rounded">
              ...
              <p className="text-gray-700">
                Saturday, May 15 – Thursday, May 17, 2025
              </p>
              <p className="text-sm text-gray-600 mt-1">
                Intensive development and collaboration period
              </p>
            </div>
            <div className="p-4 bg-white border-l-4 border-emerald-500 rounded">
              <h3 className="font-bold text-gray-900 mb-1">
        ...
        <section className="mb-12 bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 border-2 border-teal-200 rounded-lg bg-teal-50">
              ...
              <p className="text-gray-700">
                Start: May 10, 2025 at 10:00 AM EEST
                <br />
            ...
            <div className="p-6 border-2 border-teal-200 rounded-lg bg-teal-50">
              ...
              <p className="text-gray-700">
                External registration link available. Details via IEEE EUI SB
                channels.
              </p>
            </div>
          </div>
        ...
        <section className="bg-linear-to-r from-emerald-100 to-teal-100 rounded-xl shadow-lg p-8">
          <h2 className="text-3xl font-bold mb-4 text-gray-900">Event Recap</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
            SolveThe17 brought together talent, innovation, and collaboration
            across the Egyptian tech ecosystem. Participants tackled real-world
            challenges with cutting-edge solutions while benefiting from expert
            mentorship, industry partnerships, and the opportunity to make
            meaningful impact. The hackathon reinforced IEEE EUI SB&apos;s
            commitment to fostering innovation and empowering the next
