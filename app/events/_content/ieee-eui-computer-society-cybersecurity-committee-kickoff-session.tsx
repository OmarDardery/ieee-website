...
export const event: EventDefinition = {
  ...
  theme: {
    page: "bg-gradient-to-br from-red-50 via-white to-slate-50",
    heading: "from-red-600 to-slate-700",
  },
  banner: {
    src: "/ieee-eui-cybersecurity-committee-kickoff.jpg",
    alt: "IEEE EUI Computer Society Cybersecurity Committee Kickoff banner",
    frameClassName: "border-red-100",
    imageClassName: "object-contain",
  },
  meta: [
    { icon: "📅", text: "November 30 – December 8, 2025" },
    { icon: "👥", text: "IEEE Computer Society Cybersecurity Committee" },
    { icon: "🚀", text: "Term Kickoff" },
  ],
  intro:
    ...
    <>
      <section className="mb-12 bg-white rounded-xl shadow-lg p-8">
        ...
        <p className="text-gray-700 leading-relaxed">
          The kickoff session launched the Cybersecurity Committee&apos;s
          term-long journey into cybersecurity fundamentals. Attendees gained
          clarity on core concepts, career opportunities, and practical
          pathways to join cybersecurity challenges like Capture The Flag (CTF)
          competitions.
        </p>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 border-2 border-red-100 rounded-lg">
            ...
            <p className="text-gray-700">
              Foundational concepts, threat landscapes, and the role of
          ...
          <div className="p-6 border-2 border-orange-100 rounded-lg">
            ...
            <p className="text-gray-700">
              Confidentiality, Integrity, and Availability—the core pillars of
              information security.
            </p>
          </div>
          <div className="p-6 border-2 border-yellow-100 rounded-lg">
            <h3 className="font-bold text-lg text-gray-900 mb-2">
              💼 Cybersecurity Domains & Job Profiles
            </h3>
            <p className="text-gray-700">
              Career paths including ethical hacking, security analysis,
              compliance, and threat intelligence.
            </p>
          </div>
          <div className="p-6 border-2 border-emerald-100 rounded-lg">
            <h3 className="font-bold text-lg text-gray-900 mb-2">
              🎯 CTFs & Getting Started
            </h3>
            <p className="text-gray-700">
              What Capture The Flag competitions are and how to begin
              participating and competing.
            </p>
          </div>
          <div className="p-6 border-2 border-blue-100 rounded-lg md:col-span-2">
            <h3 className="font-bold text-lg text-gray-900 mb-2">
              📚 Roadmap, Resources & Learning Platforms
            </h3>
            <p className="text-gray-700">
              Recommended learning path, free tools, platforms like MaharaTech,
              and resources for self-paced progress.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12 bg-gradient-to-r from-red-50 to-slate-50 rounded-xl shadow-lg p-8">
        ...
        <div className="space-y-4">
          <div className="p-5 bg-white border-l-4 border-red-500 rounded">
            ...
            <p className="text-gray-700">
              Build strong understanding of security principles, threats, and
          ...
          <div className="p-5 bg-white border-l-4 border-orange-500 rounded">
            ...
            <p className="text-gray-700">
              Hands-on labs and tools to apply security concepts in controlled
              environments.
            </p>
          </div>
          <div className="p-5 bg-white border-l-4 border-yellow-500 rounded">
            ...
            <p className="text-gray-700">
              Compete in capture-the-flag challenges to test knowledge and
          ...
          <div className="p-5 bg-white border-l-4 border-emerald-500 rounded">
            ...
            <p className="text-gray-700">
              Progress to specialized domains like penetration testing, malware
      ...
      <section className="mb-12 bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="p-6 border-2 border-red-200 rounded-lg bg-red-50">
          <h3 className="text-xl font-bold text-red-800 mb-4">
            📋 Assigned for Next Session
          </h3>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3">
              <span className="text-red-600 font-bold">→</span>
              <span>
                Complete MaharaTech cybersecurity modules to reinforce
            ...
            <li className="flex items-start gap-3">
              <span className="text-red-600 font-bold">→</span>
              <span>
                Set up cybersecurity lab environment with recommended tools
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-red-600 font-bold">→</span>
            ...
            <li className="flex items-start gap-3">
              <span className="text-red-600 font-bold">→</span>
              <span>
                Prepare questions and topics for deeper discussion next session
              </span>
            </li>
          </ul>
        </div>
      ...
      <section className="bg-gradient-to-r from-red-100 to-slate-100 rounded-xl shadow-lg p-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          The Cybersecurity Committee kickoff energized attendees with a clear
          vision of what cybersecurity entails—from foundational theory to
          cutting-edge practice. Through the CIA Triad framework, career
          insights, and practical CTF guidance, participants left equipped with
          a roadmap and resources to launch their cybersecurity journey. The
          assigned MaharaTech modules and lab setup ensure momentum heading
          into the committee&apos;s next phase.
        </p>
