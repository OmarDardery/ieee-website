      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-10">
        <section className="rounded-3xl border border-amber-100 bg-white/80 p-8 shadow-lg shadow-amber-100/40 backdrop-blur">
          ...
          <p className="mt-4 text-lg text-gray-700">
            We design accessible, sustainable solutions with and for underserved
          ...
          {["Energy Access", "Health", "Education"].map((focus) => (
            ...
            >
              ...
              <p className="mt-2 text-gray-700">
                Co-design sprints, prototyping, and field testing with community
                feedback loops.
              </p>
            </div>
          ))}
        ...
        <section className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
          ...
          <p className="mt-3 text-gray-700">
            Multidisciplinary teams scope, prototype, and validate solutions
            alongside local stakeholders. We aim for measurable, sustainable
            outcomes.
          </p>
